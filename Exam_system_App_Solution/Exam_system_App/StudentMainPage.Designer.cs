namespace Exam_system_App
{
    partial class StudentMainPage
    {
        ...
        private void InitializeComponent()
        {
            ...
            studnamenewexamtxt.BackColor = Color.Transparent;
            studnamenewexamtxt.Font = new Font("Segoe UI", 15F, FontStyle.Bold);
            studnamenewexamtxt.ForeColor = Color.FromArgb(192, 0, 0);
            ...
            studidnewexamtxt.BackColor = Color.Transparent;
            studidnewexamtxt.Font = new Font("Segoe UI", 15F);
            studidnewexamtxt.ForeColor = Color.FromArgb(192, 0, 0);
            ...
            GrdGridView.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill;
            GrdGridView.AutoSizeRowsMode = DataGridViewAutoSizeRowsMode.AllCells;
            GrdGridView.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
            GrdGridView.GridColor = Color.DarkGray;
            GrdGridView.Location = new Point(3, 2);
            GrdGridView.Name = "GrdGridView";
            GrdGridView.RowHeadersWidth = 51;
            ...
            FormClosing += StudentMainPage_FormClosing;
