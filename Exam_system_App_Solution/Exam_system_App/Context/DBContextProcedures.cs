...
namespace Exam_system_App.Context
{
    public partial class DBContext
    {
        ...
        protected void OnModelCreatingGeneratedProcedures(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ExamGradeResult>().HasNoKey().ToView(null);
    ...
    public partial class DBContextProcedures : IDBContextProcedures
    {
        ...
        public virtual async Task<List<ExamGradeResult>> ExamGradeAsync(int? st_id, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            var parameterreturnValue = new SqlParameter
            {
                ParameterName = "returnValue",
            ...
            var _ = await _context.SqlQueryAsync<ExamGradeResult>("EXEC @returnValue = [dbo].[ExamGrade] @st_id", sqlParameters, cancellationToken);
        ...
        public virtual async Task<int> ExamGrade_calcAsync(int? ex_Id, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default)
        {
            var parameterreturnValue = new SqlParameter
            {
                ParameterName = "returnValue",
            ...
            var _ = await _context.Database.ExecuteSqlRawAsync("EXEC @returnValue = [dbo].[ExamGrade_calc] @ex_Id", sqlParameters, cancellationToken);
