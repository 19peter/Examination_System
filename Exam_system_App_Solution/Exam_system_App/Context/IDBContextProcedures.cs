...
namespace Exam_system_App.Context
{
    public partial interface IDBContextProcedures
    {
        ...
        Task<List<ExamGradeResult>> ExamGradeAsync(int? st_id, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default);
        Task<int> ExamGrade_calcAsync(int? ex_Id, OutputParameter<int> returnValue = null, CancellationToken cancellationToken = default);
